...
export async function POST(request: NextRequest) {
  try {
    ...
    const instructions = [
      ...
      "Estructura la respuesta en: 1) Progreso observado, 2) Posibles estancamientos o riesgos, 3) Recomendaciones concretas (cargas, reps, ejercicios, frecuencia).",
      "Si hay pocos datos, dilo y da consejos generales prudentes.",
